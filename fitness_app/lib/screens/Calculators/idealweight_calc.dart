                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(
                        onPressed:
                            _isCalculating ? null : _calculateIdealWeight,
                        style: ElevatedButton.styleFrom(
                          backgroundColor: PrimaryColor,
                          minimumSize: Size(size.width * 0.9, 50),
                          shape: RoundedRectangleBorder(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (widget.onComplete != null) {
                      widget.onComplete!({
                        'Hamwi Method':
                            '${_idealWeights['Hamwi']!.toStringAsFixed(1)} kg',
                        'Devine Method':
                            '${_idealWeights['Devine']!.toStringAsFixed(1)} kg',
                        'Robinson Method':
                            '${_idealWeights['Robinson']!.toStringAsFixed(1)} kg',
                        'Miller Method':
                            '${_idealWeights['Miller']!.toStringAsFixed(1)} kg',
                        'Average':
                            '${(_idealWeights.values.reduce((a, b) => a + b) / _idealWeights.length).toStringAsFixed(1)} kg',
                      });
                    }
                  },
                  style: ElevatedButton.styleFrom(
