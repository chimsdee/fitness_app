  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData.dark().copyWith(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: Color.fromARGB(255, 1, 232, 224)),
          ),
      ...
      routes: {
        ...
        '/settings_Notifications': (context) => const Settings_Notifications(),
        '/privacyPolicy': (context) => const privacy_policy.PrivacyPolicyPage(),
        '/idealWeightCalculator': (context) => const IdealWeightCalculatorPage(),
        '/multiCalculatorFlow': (context) => const MultiCalculatorFlow(),
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.of(details.context as BuildContext).pushAndRemoveUntil(
                      MaterialPageRoute(
